...
var DateRangePicker = /*#__PURE__*/function (_ref) {
  ...
  _proto.onDateRangePickerInputFocus = function onDateRangePickerInputFocus(focusedInput) {
    ...
    if (focusedInput) {
      ...
      var moveFocusToDayPicker = withAnyPortal && !keepFocusOnInput || readOnly && !keepFocusOnInput || this.isTouchDevice && !keepFocusOnInput;
  ...
  _proto.render = function render() {
    var _this$props8 = this.props,
        ...
        keepFocusOnInput = _this$props8.keepFocusOnInput;
    var isDateRangePickerInputFocused = this.state.isDateRangePickerInputFocused;
    var enableOutsideClick = !withPortal && !withFullScreenPortal;
    var hideFang = verticalSpacing < FANG_HEIGHT_PX;
    var disabledByPortal = focusedInput && (withPortal || withFullScreenPortal) && !keepFocusOnInput;
